...
Yksinkertainen versio pelistä, joka pohjautuu Alfapet-lautapeliin. Tässä pelissä ei ole kuitenkaan pelilautaa käytössä, vaan peliin luodaan sanat tekstikenttään. Pelissä on rajallinen määrä kirjaimia varastossa, ja pelaajien käyttöön arvotaan pelin edetessä kirjaimia tästä varastosta. Kullakin pelaajalla on enintään 6-10 kirjainta käytössä, riippuen pelaajan valinnasta.
...
HUOM! Vanhan version (johon sisältyi pelilauta) aihekuvaus löytyy branchistä Lautapeli, kansiosta Dokumentaatio.